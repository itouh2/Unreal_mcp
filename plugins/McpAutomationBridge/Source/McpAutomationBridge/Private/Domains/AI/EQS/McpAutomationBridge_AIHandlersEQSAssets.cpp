...
{
    UEnvQuery* Query = CreateAIAssetInPackage<UEnvQuery>(
        Path, Name, TEXT("EQS Query"), OutError);
    if (Query)
    {
...
// Implements the "create_eqs_query" action.
...
// Implements the "add_eqs_generator" action.
