...
public:
	...
	TSharedPtr<FJsonObject> BuildInputSchema() const override
	{
		FMcpSchemaBuilder Schema;
			...
			Schema.StringEnum(TEXT("edit"), { TEXT("add_parameter"), TEXT("reset_parameters"), TEXT("create"), TEXT("add_value"), TEXT("rename_value"), TEXT("reorder_values"), TEXT("set_value_metadata"), TEXT("split"), TEXT("create_row_struct"), TEXT("add_row"), TEXT("update_row"), TEXT("import_rows"), TEXT("set_row_struct"), TEXT("set_struct_as_row_struct"), TEXT("create_struct"), TEXT("add_struct_member"), TEXT("rename_struct_member"), TEXT("reorder_struct_members"), TEXT("set_struct_member_default"), TEXT("set_struct_member_metadata"), TEXT("set_struct_member_type"), TEXT("rename_struct"), TEXT("duplicate_struct"), TEXT("import_struct"), TEXT("recompile_struct"), TEXT("refresh_struct_dependencies"), TEXT("set_instanced_struct_property") }, TEXT("Which edit data table variant to run."));
