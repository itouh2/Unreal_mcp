...
const testCases = [
  ...
  { scenario: 'STRUCT: inspect_struct on a known engine struct', toolName: 'inspect', arguments: { action: 'inspect_struct', structPath: '/Script/Engine.Vector' }, expected: 'success', assertions: [{ path: 'structuredContent.result.structName', equals: 'Vector', label: 'engine struct name reported' }, { path: 'structuredContent.result.members', minLength: 1, label: 'at least one member enumerated' }] },
