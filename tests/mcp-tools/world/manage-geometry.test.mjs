...
const testCases = [
  ...
  // === CREATE ===
  // NOTE: primitive create_* actions spawn LEVEL actors and do not take a `path`
  // (the param was declared historically but silently ignored by the handlers;
  // removed from the schema, so it must not be sent here either).
  { scenario: 'CREATE: create_box', toolName: 'manage_geometry', arguments: {"action": "create_box", "name": `Testbox_${ts}`, "width": 120, "height": 80, "depth": 60, "widthSegments": 2, "heightSegments": 2, "depthSegments": 2, "rotation": {"pitch": 0, "yaw": 15, "roll": 0}, "scale": {"x": 1, "y": 1, "z": 1}}, expected: 'success|already exists' },
  { scenario: 'CREATE: create_sphere', toolName: 'manage_geometry', arguments: {"action": "create_sphere", "name": `Testsphere_${ts}`, "radius": 45, "radialSegments": 12}, expected: 'success|already exists' },
  { scenario: 'CREATE: create_cylinder', toolName: 'manage_geometry', arguments: {"action": "create_cylinder", "name": `Testcylinder_${ts}`, "radius": 40, "height": 120, "numSides": 12}, expected: 'success|already exists' },
  { scenario: 'CREATE: create_cone', toolName: 'manage_geometry', arguments: {"action": "create_cone", "name": `Testcone_${ts}`, "radius": 45, "height": 110, "numSides": 12}, expected: 'success|already exists' },
  { scenario: 'CREATE: create_capsule', toolName: 'manage_geometry', arguments: {"action": "create_capsule", "name": `Testcapsule_${ts}`, "radius": 35, "radialSegments": 12, "numRings": 4}, expected: 'success|already exists' },
  { scenario: 'CREATE: create_torus', toolName: 'manage_geometry', arguments: {"action": "create_torus", "name": `Testtorus_${ts}`, "radius": 70, "innerRadius": 20, "numSides": 18, "radialSegments": 8}, expected: 'success|already exists' },
  { scenario: 'CREATE: create_plane', toolName: 'manage_geometry', arguments: {"action": "create_plane", "name": "Testplane"}, expected: 'success|already exists' },
  { scenario: 'CREATE: create_disc', toolName: 'manage_geometry', arguments: {"action": "create_disc", "name": `Testdisc_${ts}`, "radius": 55, "numSides": 24}, expected: 'success|already exists' },
  { scenario: 'CREATE: create_stairs', toolName: 'manage_geometry', arguments: {"action": "create_stairs", "name": `Teststairs_${ts}`, "numSteps": 5, "stepWidth": 90, "stepHeight": 18, "stepDepth": 28}, expected: 'success|already exists' },
  { scenario: 'CREATE: create_spiral_stairs', toolName: 'manage_geometry', arguments: {"action": "create_spiral_stairs", "name": `Testspiral_stairs_${ts}`, "numSteps": 6, "stepWidth": 80, "stepHeight": 16, "innerRadius": 120, "numTurns": 0.5}, expected: 'success|already exists' },
  ...
  { scenario: 'CREATE: create_ring', toolName: 'manage_geometry', arguments: {"action": "create_ring", "name": `Testring_${ts}`, "radius": 55, "innerRadius": 25, "outerRadius": 55, "numSides": 24}, expected: 'success|already exists' },
  ...
  { scenario: 'CREATE: create_ramp', toolName: 'manage_geometry', arguments: {"action": "create_ramp", "name": "Testramp"}, expected: 'success|already exists' },
  // === ACTION ===
  ...
  { scenario: 'ACTION: extrude selected triangles', toolName: 'manage_geometry', arguments: {"action": "extrude", "actorName": EDIT_ACTOR, "amount": 4, "triangleIndices": [0, 1]}, expected: 'success' },
  { scenario: 'ACTION: inset selected triangles', toolName: 'manage_geometry', arguments: {"action": "inset", "actorName": EDIT_ACTOR, "distance": 2, "triangleIndices": [0, 1]}, expected: 'success' },
  { scenario: 'ACTION: outset selected triangles', toolName: 'manage_geometry', arguments: {"action": "outset", "actorName": EDIT_ACTOR, "triangleIndices": [0, 1]}, expected: 'success' },
  { scenario: 'ACTION: bevel selected triangles', toolName: 'manage_geometry', arguments: {"action": "bevel", "actorName": EDIT_ACTOR, "triangleIndices": [0, 1]}, expected: 'success' },
  { scenario: 'ACTION: offset_faces selected triangles', toolName: 'manage_geometry', arguments: {"action": "offset_faces", "actorName": EDIT_ACTOR, "triangleIndices": [0, 1]}, expected: 'success' },
  { scenario: 'ACTION: chamfer selected triangles', toolName: 'manage_geometry', arguments: {"action": "chamfer", "actorName": EDIT_ACTOR, "triangleIndices": [0, 1]}, expected: 'success' },
  { scenario: 'Reset: cleanup geometry actors', toolName: 'control_actor', arguments: { action: 'delete_by_tag', tag: 'GeoTest' }, expected: 'success|not found' },
