...
const testCases = [
  ...
  { scenario: 'CREATE: create_cone', toolName: 'manage_geometry', arguments: {"action": "create_cone", "name": `Testcone_${ts}`, "radius": 45, "baseRadius": 50, "topRadius": 20, "height": 110, "numSides": 12}, expected: 'success|already exists' },
  { scenario: 'CREATE: create_capsule', toolName: 'manage_geometry', arguments: {"action": "create_capsule", "name": `Testcapsule_${ts}`, "radius": 35, "length": 120, "radialSegments": 12, "numRings": 4}, expected: 'success|already exists' },
  ...
  { scenario: 'CREATE: create_stairs', toolName: 'manage_geometry', arguments: {"action": "create_stairs", "name": `Teststairs_${ts}`, "numSteps": 5, "stepWidth": 90, "stepHeight": 18, "stepDepth": 28, "floating": false}, expected: 'success|already exists' },
