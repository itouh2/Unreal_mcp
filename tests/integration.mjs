...
const testCases = [
  ...
  { scenario: 'Asset: create test folder', toolName: 'manage_asset', arguments: { action: 'create_folder', path: TEST_FOLDER }, expected: 'success|already exists', consent: { capability: 'asset.create_folder', acknowledge: 'explicit' } },
  { scenario: 'Asset: create material', toolName: 'manage_asset', arguments: { action: 'create_material', name: 'M_IntegrationTest', path: TEST_FOLDER }, expected: 'success|already exists', consent: { capability: 'material.create_material', acknowledge: 'explicit' } },
  ...
  { scenario: 'Blueprint: create Actor blueprint', toolName: 'manage_blueprint', arguments: { action: 'create', name: 'BP_IntegrationTest', savePath: TEST_FOLDER, parentClass: 'Actor' }, expected: 'success|already exists' },
  // Struct
  { scenario: 'Struct: Create test struct', toolName: 'manage_asset', arguments: { action: 'create_struct', name: 'S_IntegrationTest', path: TEST_FOLDER }, expected: 'success|already exists', consent: { capability: 'struct.edit_struct', acknowledge: 'explicit' } },
  { scenario: 'Struct: Add struct member', toolName: 'manage_asset', arguments: { action: 'add_struct_member', structPath: `${TEST_FOLDER}/S_IntegrationTest`, memberName: 'Weight', memberType: 'Float', defaultValue: '1.0' }, expected: 'success', consent: { capability: 'struct.edit_struct', acknowledge: 'explicit' } },
  ...
  { scenario: 'Struct: Recompile struct', toolName: 'manage_asset', arguments: { action: 'recompile_struct', structPath: `${TEST_FOLDER}/S_IntegrationTest` }, expected: 'success', consent: { capability: 'struct.edit_struct', acknowledge: 'explicit' } },
  { scenario: 'Struct: Delete test struct', toolName: 'manage_asset', arguments: { action: 'delete_struct', structPath: `${TEST_FOLDER}/S_IntegrationTest` }, expected: 'success|not found', consent: { capability: 'struct.delete_struct', acknowledge: 'elevated' } },
  { scenario: 'Geometry: Create box primitive', toolName: 'manage_geometry', arguments: { action: 'create_box', name: 'GeoTest_Box', dimensions: { x: 100, y: 100, z: 100 }, location: { x: 0, y: 0, z: 100 } }, expected: 'success|already exists' },
  ...
  { scenario: 'Content: preview migrating a template subtree', toolName: 'manage_asset', arguments: { action: 'migrate_assets', sourceRoot: 'engineTemplates', sourceId: 'TP_ThirdPersonBP', subPath: 'ThirdPerson', destinationPath: '/Game', overwrite: false, dryRun: true, maxPackages: 4000 }, expected: 'success|not found', consent: { capability: 'asset.maintain_content', acknowledge: 'explicit' } },
  { scenario: 'Content: reject a sourceRoot escape', toolName: 'manage_asset', arguments: { action: 'migrate_assets', sourceRoot: 'engineTemplates', sourceId: '../../../Windows' }, expected: 'error', consent: { capability: 'asset.maintain_content', acknowledge: 'explicit' } },
  { scenario: 'Content: list downloaded Fab packs', toolName: 'manage_asset', arguments: { action: 'list_fab_downloads' }, expected: 'success' },
  { scenario: 'Content: Fab download rejects a non-https url', toolName: 'manage_asset', arguments: { action: 'download_fab_asset', assetId: 'it-1', downloadUrl: 'ftp://bad', destinationDirectory: '', downloadType: 'http' }, expected: 'error', consent: { capability: 'asset.import_marketplace_asset', acknowledge: 'explicit' } },
  { scenario: 'Content: Fab details rejects a listing id with path characters', toolName: 'manage_asset', arguments: { action: 'get_fab_listing_details', listingId: '../../i/auth' }, expected: 'error', consent: { capability: 'asset.import_marketplace_asset', acknowledge: 'explicit' } },
  { scenario: 'Content: Fab search rejects a query with quotes', toolName: 'manage_asset', arguments: { action: 'search_fab_listings', query: 'rock" OR 1=1', freeOnly: true, limit: 5 }, expected: 'error', consent: { capability: 'asset.import_marketplace_asset', acknowledge: 'explicit' } },
  { scenario: 'Content: Fab add rejects a listing id with path characters', toolName: 'manage_asset', arguments: { action: 'add_fab_asset_to_project', listingId: '../../i/auth' }, expected: 'error', consent: { capability: 'asset.import_marketplace_asset', acknowledge: 'explicit' } },
  ...
  { scenario: 'Content: import Megascans without required fields', toolName: 'manage_asset', arguments: { action: 'import_megascans_asset', assetPaths: [], folderName: 'IT_Missing', assetType: '3d', exportMode: 'normal', assetId: 'it-1', name: 'IT Missing' }, expected: 'error', consent: { capability: 'asset.import_marketplace_asset', acknowledge: 'explicit' } },
  ...
  { scenario: 'Asset: create advanced test folder', toolName: 'manage_asset', arguments: { action: 'create_folder', path: ADV_TEST_FOLDER }, expected: 'success|already exists', consent: { capability: 'asset.create_folder', acknowledge: 'explicit' } },
  { scenario: 'Material Authoring: Create material', toolName: 'manage_asset', arguments: { action: 'create_material', name: 'M_AdvTest', path: ADV_TEST_FOLDER }, expected: 'success|already exists', consent: { capability: 'material.create_material', acknowledge: 'explicit' } },
  { scenario: 'Texture: Create noise texture', toolName: 'manage_asset', arguments: { action: 'create_noise_texture', name: 'T_TestNoise', path: ADV_TEST_FOLDER }, expected: 'success|already exists', consent: { capability: 'texture.create_texture', acknowledge: 'explicit' } },
  ...
  { scenario: 'Networking setup: create character blueprint', toolName: 'manage_blueprint', arguments: { action: 'create', name: 'BP_TestCharacter', savePath: ADV_TEST_FOLDER, parentClass: 'Character' }, expected: 'success|already exists' },
  ...
  { scenario: 'Cleanup: delete test actor', toolName: 'control_actor', arguments: { action: 'delete', actorName: 'IT_Cube' }, expected: 'success|not found', consent: { capability: 'control_actor.delete', acknowledge: 'explicit' } },
  { scenario: 'Cleanup: delete test folder', toolName: 'manage_asset', arguments: { action: 'delete', path: TEST_FOLDER, force: true }, expected: 'success|not found', timeoutMs: 30000, consent: { capability: 'asset.delete', acknowledge: 'elevated' } },
  { scenario: 'Cleanup: delete advanced test folder', toolName: 'manage_asset', arguments: { action: 'delete', path: ADV_TEST_FOLDER, force: true }, expected: 'success|not found', timeoutMs: 30000, consent: { capability: 'asset.delete', acknowledge: 'elevated' } }
];
