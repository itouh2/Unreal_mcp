...
export const GEOMETRY_OPTIMIZE_RECORDS: readonly CapabilityRecordSource[] = [
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, hullCount: P.hullCount, maxHullCount: P.maxHullCount, maxHullVerts: P.maxHullVerts, maxVerticesPerHull: P.maxVerticesPerHull, hullPrecision: P.hullPrecision, targetActor: P.targetActor }, required: [], requiredOneOf: ['actorName', 'targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'medium',
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, outputPath: P.outputPath, targetActor: P.targetActor, assetPath: P.assetPath }, required: ['assetPath'], requiredOneOf: ['actorName', 'targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'medium',
