...
export const GEOMETRY_DEFORM_RECORDS: readonly CapabilityRecordSource[] = [
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, targetActor: P.targetActor, iterations: P.iterations }, required: [], requiredOneOf: ['actorName', 'targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, position: P.position, targetActor: P.targetActor, latticeResolution: P.latticeResolution, weight: P.weight }, required: [], requiredOneOf: ['actorName', 'targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'medium',
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, targetActor: P.targetActor, texturePath: P.texturePath, heightScale: P.heightScale, midpoint: P.midpoint }, required: ['texturePath'], requiredOneOf: ['actorName', 'targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
