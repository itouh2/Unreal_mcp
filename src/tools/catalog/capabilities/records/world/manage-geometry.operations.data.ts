...
export const GEOMETRY_OPERATIONS_RECORDS: readonly CapabilityRecordSource[] = [
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, amount: P.amount, targetActor: P.targetActor, offset: P.offset }, required: ['targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, distance: P.distance, targetActor: P.targetActor }, required: ['targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, targetActor: P.targetActor, offset: P.offset }, required: ['targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
