...
export const GEOMETRY_OPERATIONS_RECORDS: readonly CapabilityRecordSource[] = [
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, targetActor: P.targetActor, offset: P.offset, triangleIndices: P.triangleIndices }, required: [], requiredOneOf: ['actorName', 'targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
  ...
  buildWorldRecord({
    ...
    inputProps: { actorName: P.actorName, targetActor: P.targetActor, steps: P.steps }, required: [], requiredOneOf: ['actorName', 'targetActor'], effect: 'write', costLatency: 'interactive', costResources: 'low',
